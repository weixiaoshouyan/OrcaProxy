...
export const translations = {
  zh: {
    ...
    'menu.tasks': 'Agent 任务',
    'menu.mcp': 'MCP 权限',
    'menu.codeSearch': '代码检索',
    'menu.eval': 'Agent 评估',
    'menu.group.stats': '数据与统计',
    'menu.group.integration': '模型与集成',
    'menu.group.tasks': '任务与检索',
    'menu.group.ops': '运维与审计',
    ...
    'settings.autostart': '开机自启动 (Open at Login)',
    'settings.autostart.desktopOnly': '仅 Electron 桌面版生效；浏览器模式下仅保存偏好。',
    'settings.autostart.failed': '设置开机自启动失败',
  ...
  en: {
    ...
    'menu.tasks': 'Agent Tasks',
    'menu.mcp': 'MCP Permissions',
    'menu.codeSearch': 'Code Search',
    'menu.eval': 'Agent Evaluation',
    'menu.group.stats': 'Data & Stats',
    'menu.group.integration': 'Models & Integration',
    'menu.group.tasks': 'Tasks & Search',
    'menu.group.ops': 'Ops & Audit',
    ...
    'settings.autostart.desktopOnly': 'Only applies in the Electron desktop app; browsers just save the preference.',
    'settings.autostart.failed': 'Failed to update start-at-login setting',
